<x-job-layout title="Cari Lowongan Pekerjaan">
    <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('jobs.index') }}" method="GET" class="mb-4">
            <div class="flex flex-col gap-4 md:flex-row rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
                ...
                <div class="relative flex-1">
                    ...
                    <input 
                        ...
                        class="w-full rounded-xl border-none bg-slate-50 py-3.5 pl-12 pr-4 text-sm text-slate-900 outline-none focus:ring-0"
                    >
                </div>
            ...
            <div class="mt-4 flex flex-col gap-4 md:flex-row md:items-end rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <div class="flex-1">
                    ...
                    <select 
                        name="category" 
                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-700 outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900 appearance-none"
                    >
                ...
                <div class="flex-shrink-0">
                    <a 
                        ...
                        class="inline-block rounded-xl border border-slate-300 bg-white px-6 py-2.5 text-sm font-semibold text-slate-700 transition hover:border-slate-900 hover:bg-slate-50"
                    >
                        Hapus Filter
                    </a>
                </div>
        ...
        <div class="space-y-4">
            @forelse($jobs as $job)
                <!-- Job Card -->
                <div class="relative flex flex-col rounded-2xl border border-slate-300 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-slate-900">
            ...
            @empty
                <div class="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white py-20 px-6 text-center">
                    ...
                    <p class="mt-2 text-sm text-slate-500 max-w-sm">
                        Maaf, kami tidak dapat menemukan lowongan pekerjaan yang sesuai dengan kriteria pencarian Anda. Silakan coba kata kunci lain.
                    </p>
                    
                    <a 
                        href="{{ route('jobs.index') }}" 
                        class="mt-6 inline-flex items-center justify-center rounded-xl bg-emerald-50 px-5 py-2.5 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100"
                    >
                        Reset Pencarian
                    </a>
                </div>
